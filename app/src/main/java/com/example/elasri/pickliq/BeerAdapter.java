...
public class BeerAdapter extends RecyclerView.Adapter<BeerAdapter.MyViewHolder>{
    ...
    public BeerAdapter(Context context, ArrayList<Alcohol> alcohols){
        this.context=context;
        alcohollist = alcohols;
    }

    @Override
    public BeerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(BeerAdapter.MyViewHolder holder, int position) {
