...
public class GinAdapter extends RecyclerView.Adapter<GinAdapter.MyViewHolder>{
    ...
    public GinAdapter(Context context,ArrayList<Alcohol> alcohols){
        this.context=context;
        alcohollist = alcohols;
    }
    @Override
    public GinAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.infos_alcohol_item, parent, false);
        GinAdapter.MyViewHolder vh= new GinAdapter.MyViewHolder(v);
        return  vh;
    }

    @Override
    public void onBindViewHolder(GinAdapter.MyViewHolder holder, int position) {
