...
public class GinFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        invokeWSAllGinAlcohol();

    }

    private void invokeWSAllGinAlcohol() {
        AsyncHttpClient client = new AsyncHttpClient();
        String url = Config.IPURL+"getCategoryAlcohol/Gin/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView =  inflater.inflate(R.layout.fragment_gin, container, false);
        RecyclerView rv = (RecyclerView) rootView.findViewById(R.id.gin_recycler_view);
        ...
        adapter = new GinAdapter(this.getContext(),alcohollist);
