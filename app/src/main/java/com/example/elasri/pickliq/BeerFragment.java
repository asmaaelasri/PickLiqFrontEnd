...
public class BeerFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        invokeWSAllBeerAlcohol();

    }

    private void invokeWSAllBeerAlcohol() {
        AsyncHttpClient client = new AsyncHttpClient();
        String url = Config.IPURL+"getCategoryAlcohol/Beer/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView rv = (RecyclerView) rootView.findViewById(R.id.beer_recycler_view);
        ...
        adapter = new BeerAdapter(this.getContext(),alcohollist);
