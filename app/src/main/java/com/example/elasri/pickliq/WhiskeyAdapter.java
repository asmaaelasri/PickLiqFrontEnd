...
public class WhiskeyAdapter extends RecyclerView.Adapter<WhiskeyAdapter.MyViewHolder>{
    ...
    public WhiskeyAdapter(Context context, ArrayList<Alcohol> alcohols){
    ...
    @Override
    public WhiskeyAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.infos_alcohol_item, parent, false);
        WhiskeyAdapter.MyViewHolder vh= new WhiskeyAdapter.MyViewHolder(v);
        return  vh;
    }

    @Override
    public void onBindViewHolder(WhiskeyAdapter.MyViewHolder holder, int position) {
