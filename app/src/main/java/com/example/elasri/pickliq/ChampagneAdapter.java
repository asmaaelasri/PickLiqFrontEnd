...
public class ChampagneAdapter extends RecyclerView.Adapter<ChampagneAdapter.MyViewHolder>{
    ...
    public ChampagneAdapter(Context context,  ArrayList<Alcohol> alcohols){
        this.context=context;
        alcohollist = alcohols;
    }

    @Override
    public ChampagneAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.infos_alcohol_item, parent, false);
        ChampagneAdapter.MyViewHolder vh= new ChampagneAdapter.MyViewHolder(v);
        return  vh;
    }

    @Override
    public void onBindViewHolder(ChampagneAdapter.MyViewHolder holder, int position) {
