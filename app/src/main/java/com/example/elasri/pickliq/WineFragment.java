...
public class WineFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        invokeWSAllWineAlcohol();

    }

    private void invokeWSAllWineAlcohol() {
        AsyncHttpClient client = new AsyncHttpClient();
        String url = Config.IPURL+"getCategoryAlcohol/Wine/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView rv = (RecyclerView) rootView.findViewById(R.id.wine_recycler_view);
        ...
        adapter = new WineAdapter(this.getContext(),alcohollist);
