...
public class WhiskeyFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        invokeWSAllWhiskeyAlcohol();

    }

    private void invokeWSAllWhiskeyAlcohol() {
        AsyncHttpClient client = new AsyncHttpClient();
        String url = Config.IPURL+"getCategoryAlcohol/Whiskey/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView =  inflater.inflate(R.layout.fragment_whiskey, container, false);
        RecyclerView rv = (RecyclerView) rootView.findViewById(R.id.whiskey_recycler_view);
        ...
        adapter = new WhiskeyAdapter(this.getContext(),alcohollist);
