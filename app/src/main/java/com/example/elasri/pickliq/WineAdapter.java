...
public class WineAdapter extends RecyclerView.Adapter<WineAdapter.MyViewHolder>{
    ...
    public WineAdapter(Context context, ArrayList<Alcohol> alcohols){
    ...
    @Override
    public WineAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.infos_alcohol_item, parent, false);
        WineAdapter.MyViewHolder vh= new WineAdapter.MyViewHolder(v);
        return  vh;
    }

    @Override
    public void onBindViewHolder(WineAdapter.MyViewHolder holder, int position) {
