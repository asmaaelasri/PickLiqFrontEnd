...
public class BrandyFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        invokeWSAllBrandyAlcohol();

    }

    private void invokeWSAllBrandyAlcohol() {
        AsyncHttpClient client = new AsyncHttpClient();
        String url = Config.IPURL+"getCategoryAlcohol/Brandy/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView =  inflater.inflate(R.layout.fragment_brandy, container, false);
        RecyclerView rv = (RecyclerView) rootView.findViewById(R.id.brandy_recycler_view);
        ...
        adapter = new BrandyAdapter(this.getContext(),alcohollist);
