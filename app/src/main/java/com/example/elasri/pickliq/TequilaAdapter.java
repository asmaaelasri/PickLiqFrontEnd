...
public class TequilaAdapter extends RecyclerView.Adapter<TequilaAdapter.MyViewHolder>{
    ...
    public TequilaAdapter(Context context,ArrayList<Alcohol> alcohols){
    ...
    @Override
    public TequilaAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.infos_alcohol_item, parent, false);
        TequilaAdapter.MyViewHolder vh= new TequilaAdapter.MyViewHolder(v);
        return  vh;
    }

    @Override
    public void onBindViewHolder(TequilaAdapter.MyViewHolder holder, int position) {
