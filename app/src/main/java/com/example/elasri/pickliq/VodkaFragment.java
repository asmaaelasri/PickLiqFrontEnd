...
public class VodkaFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        invokeWSAllVodkaAlcohol();

    }


    private void invokeWSAllVodkaAlcohol() {
        AsyncHttpClient client = new AsyncHttpClient();
        String url = Config.IPURL+"getCategoryAlcohol/Vodka/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView =  inflater.inflate(R.layout.fragment_vodka, container, false);
        RecyclerView rv = (RecyclerView) rootView.findViewById(R.id.vodka_recycler_view);
        ...
        adapter = new VodkaAdapter(this.getContext(),alcohollist);
