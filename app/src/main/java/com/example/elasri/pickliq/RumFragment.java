...
public class RumFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        invokeWSAllRumAlcohol();

    }

    private void invokeWSAllRumAlcohol() {
        AsyncHttpClient client = new AsyncHttpClient();
        String url = Config.IPURL+"getCategoryAlcohol/Rum/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView =  inflater.inflate(R.layout.fragment_rum, container, false);
        RecyclerView rv = (RecyclerView) rootView.findViewById(R.id.rum_recycler_view);
        ...
        adapter = new RumAdapter(this.getContext(),alcohollist);
