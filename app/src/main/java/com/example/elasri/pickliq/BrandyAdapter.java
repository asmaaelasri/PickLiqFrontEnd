...
public class BrandyAdapter extends RecyclerView.Adapter<BrandyAdapter.MyViewHolder>{
    ...
    public BrandyAdapter(Context context, ArrayList<Alcohol> alcohols){
    ...
    @Override
    public BrandyAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.infos_alcohol_item, parent, false);
        BrandyAdapter.MyViewHolder vh= new BrandyAdapter.MyViewHolder(v);
        return  vh;
    }

    @Override
    public void onBindViewHolder(BrandyAdapter.MyViewHolder holder, int position) {
