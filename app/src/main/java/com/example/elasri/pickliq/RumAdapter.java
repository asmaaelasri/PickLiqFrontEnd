...
public class RumAdapter extends RecyclerView.Adapter<RumAdapter.MyViewHolder>{
    ...
    public RumAdapter(Context context,ArrayList<Alcohol> alcohols){
    ...
    @Override
    public RumAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.infos_alcohol_item, parent, false);
        RumAdapter.MyViewHolder vh= new RumAdapter.MyViewHolder(v);
        return  vh;
    }

    @Override
    public void onBindViewHolder(RumAdapter.MyViewHolder holder, int position) {
