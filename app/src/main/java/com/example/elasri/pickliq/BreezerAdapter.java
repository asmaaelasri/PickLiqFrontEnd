...
public class BreezerAdapter  extends RecyclerView.Adapter<BreezerAdapter.MyViewHolder>{
    ...
    public BreezerAdapter(Context context, ArrayList<Alcohol> alcohols){
    ...
    @Override
    public BreezerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.infos_alcohol_item, parent, false);
        BreezerAdapter.MyViewHolder vh= new BreezerAdapter.MyViewHolder(v);
        return  vh;
    }

    @Override
    public void onBindViewHolder(BreezerAdapter.MyViewHolder holder, int position) {
