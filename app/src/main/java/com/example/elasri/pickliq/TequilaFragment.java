...
public class TequilaFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        invokeWSAllTequilaAlcohol();

    }

    private void invokeWSAllTequilaAlcohol() {
        AsyncHttpClient client = new AsyncHttpClient();
        String url = Config.IPURL+"getCategoryAlcohol/Tequila/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView =  inflater.inflate(R.layout.fragment_tequila, container, false);
        RecyclerView rv = (RecyclerView) rootView.findViewById(R.id.tequila_recycler_view);
        ...
        adapter = new TequilaAdapter(this.getContext(),alcohollist);
