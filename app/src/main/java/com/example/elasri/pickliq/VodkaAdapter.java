...
public class VodkaAdapter extends RecyclerView.Adapter<VodkaAdapter.MyViewHolder>{
    ...
    public VodkaAdapter(Context context, ArrayList<Alcohol> alcohols){
    ...
    @Override
    public VodkaAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.infos_alcohol_item, parent, false);
        VodkaAdapter.MyViewHolder vh= new VodkaAdapter.MyViewHolder(v);
        return  vh;
    }

    @Override
    public void onBindViewHolder(VodkaAdapter.MyViewHolder holder, int position) {
