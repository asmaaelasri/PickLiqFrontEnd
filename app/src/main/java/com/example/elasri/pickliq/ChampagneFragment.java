...
public class ChampagneFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        invokeWSAllChampagneAlcohol();

    }

    private void invokeWSAllChampagneAlcohol() {
        AsyncHttpClient client = new AsyncHttpClient();
        String url = Config.IPURL+"getCategoryAlcohol/Champagne/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new ChampagneAdapter(this.getContext(),alcohollist);
