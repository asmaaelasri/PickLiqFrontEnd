...
public class LiqueurFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        invokeWSAllLiqueurAlcohol();

    }

    private void invokeWSAllLiqueurAlcohol() {
        AsyncHttpClient client = new AsyncHttpClient();
        String url = Config.IPURL+"getCategoryAlcohol/Liqueur/";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView =  inflater.inflate(R.layout.fragment_liqueur, container, false);
        RecyclerView rv = (RecyclerView) rootView.findViewById(R.id.liqueur_recycler_view);
        ...
        adapter = new LiqueurAdapter(this.getContext(),alcohollist);
